...
// should be recolored to the player/commander color — e.g. cloth, banners, trim.
...
// ---------------------------------------------------------------------------
public class PlayerColorTarget : MonoBehaviour
{
    [System.Serializable]
    public struct Slot
    {
    ...
    [Tooltip("Renderers / material slots that take the player color (cloth, flags, trim). " +
